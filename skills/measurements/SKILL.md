...
3. **Data access (§5.4.4, SWE-094).** Certain outside parties have standing to request your raw measurement data, what you've concluded from it, and a current read on where development stands — a Center's engineering authority, the agency's top engineering office, safety and mission assurance staff at headquarters, or whichever directorate is sponsoring the work. When one of them asks, what's the actual mechanism that hands the material over? Name the mechanism, not just who's entitled to ask.
