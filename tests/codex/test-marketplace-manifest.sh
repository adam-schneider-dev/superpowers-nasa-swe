...
matching_plugins = [plugin for plugin in plugins if plugin.get("name") == "superpowers-nasa-swe"]
assert_equal(len(matching_plugins), 1, "superpowers-nasa-swe plugin entry count")
